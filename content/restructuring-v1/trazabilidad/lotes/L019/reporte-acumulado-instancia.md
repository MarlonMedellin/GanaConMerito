...
- `DESCARTAR`: `2`
- `requiere_revision_humana`: `5`
- Incidencias: las salidas del lote y este reporte acumulado no existían y devolvieron `404` antes de crearse; la enumeración de archivos requirió expandir carpetas desde la vista GitHub del repo.
- Archivos escritos:
...
- No se modificaron otros lotes fuera de los lotes auditados por esta misma instancia.