...
Ultima actualizacion: 2026-08-30 — preparación de release PATCH `v0.10.1`
...
## Release preparation v0.10.1 / dashboard patch

- Estado: release preparation; no desplegada.
- Version preparada: `0.10.1`.
