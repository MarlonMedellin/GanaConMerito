export function HeroIllustration() {
  return (
    <div
      className="public-hero-illustration w-full h-full bg-[#f8fafc] rounded-[16px] shadow-[0_10px_25px_rgba(0,0,0,0.08)] relative z-10 overflow-hidden border border-[#D6D3D1]/30 p-6 flex flex-col gap-6"
      role="img"
      aria-label="Vista ilustrativa de una pregunta con respuesta seleccionada y feedback explicativo"
    >
