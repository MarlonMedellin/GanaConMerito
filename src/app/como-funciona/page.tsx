  ...
  return (
    <div className="public-site public-page min-h-screen bg-[#FFF8F4] text-[#1e1b18] font-body-lg antialiased flex flex-col">
      ...
      <main className="public-page__main flex-1 w-full max-w-[800px] mx-auto px-6 py-16 space-y-12">
        <h1 className="public-page__title text-4xl font-bold text-[#1e1b18]">Cómo funciona GanaConMérito</h1>
        <section className="public-page__section space-y-6">
          ...
          <p className="text-lg text-[#444653] leading-relaxed">
            Resuelve preguntas de opción múltiple con única respuesta, organizadas según las áreas disponibles en el banco. La práctica busca fortalecer el razonamiento sin asumir equivalencia con una prueba oficial.
          </p>
        </section>
        <section className="public-page__section space-y-6">
